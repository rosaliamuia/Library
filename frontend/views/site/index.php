...
$totalOverduebooks = BorrowedBook::find()->asArray()->all();
?>
<div class="row">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div style="padding-top: 20px;">
             <button type="button" class="btn btn-block btn-success btn-lg assighnbook" style="width: 300px;"><i class="fa fa-plus" aria-hidden="true"></i> Assign a Book</button>
            </div>
          <?php } ?>
        ...
        <?php if(Yii::$app->user->can('student')){?>
          <div style="padding-top: 20px;">
             <button type="button" class="btn btn-block btn-success btn-lg borrowbook" style="width: 300px;"><i class="fa fa-plus" aria-hidden="true"></i> View Book</button>
            </div>
        <?php } ?>
